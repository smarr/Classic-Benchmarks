...
UnaryConstraint = class(Constraint)
...
StayConstraint = class(UnaryConstraint)
...
EditConstraint = class (UnaryConstraint)
...
BinaryConstraint = class(Constraint)
...
ScaleConstraint = class (BinaryConstraint)
...
EqualityConstraint = class (BinaryConstraint)
